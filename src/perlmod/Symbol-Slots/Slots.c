 ...
 * contents of Slots.xs. Do not edit this file, edit Slots.xs instead.
 *
...
XS_EUPXS(XS_Symbol__Slots_slots); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Symbol__Slots_slots)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "glob_sv");
    {
	SV *	RETVAL;
	SV*	glob_sv = ST(0)
;
...
extern "C"
#endif
XS_EXTERNAL(boot_Symbol__Slots); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Symbol__Slots)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        (void)newXSproto_portable("Symbol::Slots::slots", XS_Symbol__Slots_slots, file, "$");
#if PERL_VERSION_LE(5, 21, 5)
